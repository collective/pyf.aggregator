...
This is the preferred method to install pyf.aggregator, as it
...
The sources for pyf.aggregator can be downloaded from the
`Github repo <https://github.com/collective/pyf.aggregator/>`_.
...
Or download the `tarball <https://github.com/collective/pyf.aggregator/tarball/master>`_:
